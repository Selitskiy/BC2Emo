function [imageDS, dataSetFolders] = createBCbaselineIDS5(dataFolderTmpl, dataFolderSfx, readFcn)
...
dataSetFolders = [dataSetFolders, 'S1/S1HD1'];
dataSetFolders = [dataSetFolders, 'S1/S1MK3'];
dataSetFolders = [dataSetFolders, 'S1/S1MK8'];
%
