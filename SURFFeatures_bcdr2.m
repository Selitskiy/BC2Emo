...
goodCalibrBag = bagOfFeatures4(calibrSet, 'CustomExtractor', @extractFaceSURFFeatures,...
                    'VocabularySize', 50, 'StrongestFeatures', 0.8,... 
                    'UseParallel', true);
                
badCalibrBag = bagOfFeatures4(calibrSet, 'CustomExtractor', @extractNoFaceSURFFeatures,...
                    'VocabularySize', 50, 'StrongestFeatures', 0.8,... 
                    'UseParallel', true);               

%% Detect features on the trainingSet and build basis (vocabulary) of the bag
                
bag = bagOfFeatures4(trainingSet,...
