function [imageDS, dataSetFolders] = createBCbaselineIDS5e(dataFolderTmpl, dataFolderSfx, readFcn)
...
dataSetFolders = [dataSetFolders, 'S1/S1MK4'];
...
dataSetFolders = [dataSetFolders, 'S2/S2GL1'];
%
...
dataSetFolders = [dataSetFolders, 'S3/S3MK3']; 
%
...
dataSetFolders = [dataSetFolders, 'S4/S4HD1'];
%
...
dataSetFolders = [dataSetFolders, 'S5/S5MK4'];
%
...
dataSetFolders = [dataSetFolders, 'S7/S7MK3'];
dataSetFolders = [dataSetFolders, 'S7/S7FM3'];
%
...
dataSetFolders = [dataSetFolders, 'S10/S10MK1'];
%
...
dataSetFolders = [dataSetFolders, 'S11/S11MK1'];
%
...
dataSetFolders = [dataSetFolders, 'S12/S12MK1'];
%
